...
const AddItems = () => {
  ...
  const onSubmit = (data) => {
    fetch("https://warehouse-management-server-side-lilac.vercel.app/cars", {
      method: "POST",
      headers: {
      ...
      <div>
        ...
        <div className="md:w-1/4 mx-auto py-12 px-4">
          <div className="text-center">
            ...
            <p className="mt-4 mb-8 text-slate-700 ">
              Welcome back! Submit your cars description specifications image
              etc...
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className=" mx-auto mt-12">
            <input
              ...
              className=" block border-2 border-slate-500 w-full 
            ...
            <textarea
              ...
              className=" block border-2 border-slate-500 w-full pl-2 py-2 rounded-lg outline-none mt-4 text-slate-600"
            />
            <small className="text-red-500">
